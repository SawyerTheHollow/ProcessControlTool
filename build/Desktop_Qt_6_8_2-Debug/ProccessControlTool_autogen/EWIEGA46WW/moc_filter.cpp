...
static constexpr auto qt_meta_stringdata_ZN6FilterE = QtMocHelpers::stringData(
    "Filter"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN6FilterE[] = {
...
Q_CONSTINIT const QMetaObject Filter::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6FilterE.offsetsAndSizes,
    qt_meta_data_ZN6FilterE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6FilterE_t,
        // Q_OBJECT / Q_GADGET
...
void *Filter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6FilterE.stringdata0))
